...
class TestChecklist(unittest.TestCase):
	...
	def test_change_card(self):
		...
		self.assertFalse(cl._get_api_update_from_state())
		...
		self.assertEqual(cl._get_api_update_from_state().get('idCard'), new_card_id)
	...
	def test_change_misc(self):
		...
		self.assertEqual(cl._get_api_update_from_state().get('name'), new_name)
		self.assertEqual(cl._get_api_update_from_state().get('pos'), new_pos)
